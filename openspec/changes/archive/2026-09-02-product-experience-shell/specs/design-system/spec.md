...
El sistema SHALL usar tarjetas elevadas (`bg-card`, `border-border`, radio grande, `shadow-2xl shadow-black/10`) como bloque de construcción principal, con el patrón de encabezado icono/eyebrow/título/descripción y de campo etiqueta/control descrito en [sports-form.tsx](../../../../../src/presentation/components/sports-form.tsx), tipografía de interfaz legible y números tabulares; los colores de marca SHALL apoyar jerarquía y acción sin sustituir los estados semánticos.
...
- **WHEN** una superficie contiene varias secciones relacionadas
- **THEN** se agrupan dentro de la misma tarjeta usando espacio y divisores (`border-b border-border/70`) en vez de crear una tarjeta anidada por sección
